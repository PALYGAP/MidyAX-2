...
void BCR2000::colorSlider( int sliderIndex )
{
    if( g_sliderColored )
    {
        if( m_BCR2000MappingTable[ sliderIndex ].MIDIValue > 63)
            m_slidderPalette.setColor(m_TheSliders[sliderIndex]->backgroundRole(),
                                     QColor(
                                         255,
                                         255 - ( (m_BCR2000MappingTable[ sliderIndex ].MIDIValue -63) * 3.9),
                                         255 - ( (m_BCR2000MappingTable[ sliderIndex ].MIDIValue -63) * 3.9),
                                         255)  );
         else
            m_slidderPalette.setColor(m_TheSliders[sliderIndex]->backgroundRole(),
                                  QColor(
                                         255 - ( (63 - m_BCR2000MappingTable[ sliderIndex ].MIDIValue) * 3.9),
                                         255 - ( (63 -m_BCR2000MappingTable[ sliderIndex ].MIDIValue) * 3.9),
                                         255,
                                         255  )       )
        ;
