...
FCB1010::FCB1010(QWidget *parent) :
    MIDIControllerGenericDialogMOD1(parent, QString("FCB1010"), FCB1010_MC, 0, 0, 0, 0), //m_numberOfKnobs,  m_numberOfSlidders, m_numberOfParameterButtons, m_numberOfPageSelectButtons
    ui(new Ui::FCB1010)
{
    ui->setupUi(this);
    init();
